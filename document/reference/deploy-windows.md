...
- 启动项目：右击org.openmall.mall.MallAdminApplication的main方法，选择run as Java Application
...
- 启动项目：直接运行org.openmall.mall.MallAdminApplication的main方法即可
- 接口文档地址：http://localhost:8080/swagger-ui.html

## mall-search

- 启动项目：直接运行org.openmall.mall.search.MallSearchApplication的main方法即可
...
- 启动mall-portal项目：直接运行org.openmall.mall.portal.MallPortalApplication的main方法即可
